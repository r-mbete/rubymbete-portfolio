        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            <a
              ...
              className="group flex items-center gap-2.5 px-4 py-2.5 rounded-full border border-lavender-200/60 dark:border-dark-border bg-lavender-100/40 dark:bg-dark-border/40 text-gray-500 dark:text-lavender-300 hover:text-purple-primary dark:hover:text-purple-light hover:border-purple-primary/30 dark:hover:border-purple-light/30 hover:bg-purple-primary/5 dark:hover:bg-purple-light/5 transition-all duration-300 text-sm font-medium"
            >
